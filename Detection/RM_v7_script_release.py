...
# Credit to L. S. Schmidt for assistance in building the loop.
...
DEM_dir = 'DEM/Finse/InputData/11-12_resamp/'
...
for filename in os.listdir(DEM_dir):
    if filename.endswith(".tif"):
        ...
        # Iteration message
        Count = Count + 1
        print(ylw + "Iteration: " + str(Count) + " Completed, starting next iteration..." + wht)


# Completion message
print(ylw + "Package finished clustering on iteration: " + str(Count) + ". Terminating script." + wht)